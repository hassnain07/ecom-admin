                    ...
                    <table class="table table-hover datatable" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-1 py-4">Blog Heading :</th>
                                <th class="col-md-2 py-4">Blog Description</th>
...
$(document).on('click', '.delete-button', function() {
    ...
    var formAction = '{{ route("blogs.destroy", ":id") }}'; // Placeholder route
...
$(document).ready(function () {
    let table = $("#datatable").DataTable({
        ...
        ajax: "{{ url('blogs-data') }}", // Fetching users data via AJAX
        columns: [
            { 
                data: 'id', 
                name: 'checkbox', 
            ...
            { data: "heading", name: "heading" },  // Sr No
    ...
    $('#bulk-delete').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            ...
            $('#confirmDelete').off('click').on('click', function () {
                $.ajax({
                    url: '{{ route("blogs.bulkDelete") }}',  // Route for bulk delete
                    type: 'POST',
                    data: {
                        ids: selectedIds,
                        _token: '{{ csrf_token() }}'
