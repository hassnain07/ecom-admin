                    ...
                    <table class="table table-hover datatable" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2 py-4">About Img</th>
                                <th class="col-md-2 py-4">About Text</th>
...
$(document).ready(function () {
    let table = $("#datatable").DataTable({
        ...
        ajax: "{{ url('about-data') }}", // Fetching users data via AJAX
        columns: [
            { 
                data: 'id', 
                name: 'checkbox', 
            ...
            { data: "content", name: "content" },  // Email
            { 
                data: "action", 
                name: "action", 
                orderable: false, 
